...
public class JiaHeart extends Poly
{
    ...
    {
        float heartSize = v.map(p.ap.left.level(), 0, 1, 50, 200) * 8; // calculate the size of the heart based on left level channel of audio, from 0-1 to range of 50-200, multiply by 8
